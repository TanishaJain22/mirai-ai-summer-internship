...
- **AI-generated illustrations** for every scene via Pollinations AI
...
- **Graceful error handling** — story, image, and audio failures are caught independently so the experience continues
